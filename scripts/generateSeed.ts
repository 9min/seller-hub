...
sql +=
	"INSERT INTO orders (id, order_number, buyer_name, product_name, category, quantity, unit_price, total_price, status, ordered_at, shipped_at, delivered_at, is_delayed) VALUES\n";
...
const values = orders.map((o) => {
	...
	return `('${escapeStr(o.id)}', '${escapeStr(o.orderNumber)}', '${escapeStr(o.buyerName)}', '${escapeStr(o.productName)}', '${escapeStr(o.category)}', ${o.quantity}, ${o.unitPrice}, ${o.totalPrice}, '${o.status}', '${o.orderedAt}', ${shippedAt}, ${deliveredAt}, ${isDelayed})`;
});
